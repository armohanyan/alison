...
<div class="container pb50 ">
 <div class="row" >
    <div class="col-md-9 mb40" style="margin-top: 95px;">
        <article>
            <img src="{{ asset('/images/'.$course->img) }}" alt="" class="img-fluid mb30">
        ...
        @if( Auth::check() )
            ...
            @endfor
              ...
              @if(!Auth::user()->hasRateUser($course) )
            ...
            @else
                <h5>There are no rates or opinions yet...  </h5>
            @endif
    @else
        <h4 class="must-registered"> You must be registered, for see all about ratigns  and opinions</h4>
    @endif
@endsection
