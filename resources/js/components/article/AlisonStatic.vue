    ...
    <div class="alison-statics">
        <div class="statics-inner">
            <div class="learners-number">
                ...
                <span class="numbers">{{ alisonStatics.learnersQuantity }}</span>
                <span class="static-title">Learners</span>
            </div>
